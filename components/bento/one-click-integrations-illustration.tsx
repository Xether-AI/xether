...
> = ({ className = "" }) => {
  ...
  const LogoBox: React.FC<{
    ...
    if (isGradientBg) {
      boxStyle.background = `linear-gradient(180deg, var(--oci-gradient-light-gray-start) 0%, var(--oci-gradient-light-gray-end) 100%)`;
      boxStyle.boxShadow = `0px 1px 2px var(--oci-shadow-color)`;
      ...
      <div
        style={{
          ...
          background: `radial-gradient(ellipse 103.87% 77.04% at 52.56% -1.80%, 
            var(--oci-foreground-color, hsl(var(--foreground)))00 0%, 
            var(--oci-foreground-color, hsl(var(--foreground)))F5 15%, 
            var(--oci-foreground-color, hsl(var(--foreground)))66 49%, 
            var(--oci-foreground-color, hsl(var(--foreground)))F5 87%, 
            var(--oci-foreground-color, hsl(var(--foreground)))00 100%)`,
        }}
      />
